...
7. **Research usability:** Which model is better suited for downstream axial coding, audit, and codebook construction?
8. **Cost efficiency:** Which model produces usable qualitative coding outputs at lower Batch API cost?
9. **Prompt design effects:** Which observed differences are likely caused or amplified by prompt ambiguity around AI boundaries, segmentation, confidence, code splitting, or schema discipline?
...
5. model-selection scorecard
6. icon-backed section headings and scan-friendly structure
7. metric framework for model choice
8. metric definitions and caveats
9. model-level comparison table
10. coverage and completeness comparison
11. sensitivity and granularity comparison
12. evidence-overlap comparison
13. label-consistency comparison
14. boundary-risk audit
15. selected disagreement examples
16. practical recommendation for using each model
17. official-price-based Batch API cost comparison
18. prompt design evaluation and prompt-improvement recommendations
19. relative source links for human audit of selected examples
20. an improved prompt v2 linked and previewed for future batch runs
